...
class CustomExtendedSelectionText extends StatelessWidget {
  /// Creates a text widget.
  ///
  /// If the [style] argument is null, the text will use the style from the
  /// closest enclosing [DefaultTextStyle].
  const CustomExtendedSelectionText(
    String this.data, {
    Key? key,
    this.customExtendedSelectionTextStateGlobalKey,
    this.style,
    this.strutStyle,
    this.textAlign,
    this.textDirection,
  ...
  const CustomExtendedSelectionText.rich(
  ...
  final GlobalKey<CustomExtendedTextSelectionState>?
      customExtendedSelectionTextStateGlobalKey;
...
//      _editableTextKey.currentState.renderEditable;
  ...
  Widget build(BuildContext context) {
    ...
    result = CustomExtendedTextSelection(
      key: customExtendedSelectionTextStateGlobalKey,
